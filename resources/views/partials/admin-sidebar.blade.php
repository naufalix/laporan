    ...
    <nav class="sidebar-nav">
      <ul id="sidebarnav" class="p-t-20">
        ...
        <li class="sidebar-item d-none">
          <a class="sidebar-link waves-effect waves-dark sidebar-link" href="/admin/admin" aria-expanded="false">
            <i class="mdi mdi-account"></i><span class="hide-menu">Admin setting</span>
          </a>
        </li>
        <li class="sidebar-item d-none">
